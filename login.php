<?php	
	...
	if(isset($_POST['loginSubmit'])) // If the user pressed the Submit button
	{
		...
		if ($uname == "username" && $pass == "password")
		{
			...
			if ($_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~javenner/Individual_Project/index.php" 
			    || $_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~javenner/Individual_Project/login.php" )
			{
