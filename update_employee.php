<?php
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $q = $pdo->prepare($sql);
            $q->execute(array($name,$email,$mobile,$emp_id));
            Database::disconnect();
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="update_employee.php?emp_id=<?php echo $emp_id?>&loc_id=<?php echo $loc_id?>" method="post">
